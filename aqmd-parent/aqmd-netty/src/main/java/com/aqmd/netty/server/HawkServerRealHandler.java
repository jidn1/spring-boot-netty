...
public class HawkServerRealHandler extends HawkServerHandler {
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) {
        try {
            ...
            this.channelEventDealService.dealChannelDestroy(localAddress.getAddress().getHostAddress(), remoteAddress.getAddress().getHostAddress(), remoteAddress.getPort());
