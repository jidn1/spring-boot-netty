...
import com.aqmd.netty.entity.LoginMessage.LoginUser.Builder;
...
public class LoginHandler {
    ...
    public CommonResult login(long seqId, byte[] body, ChannelHandlerContext ctx) {
        Subject subject = SecurityUtils.getSubject();
        String loginIp = "";

        try {
            LoginUser user = ((Builder)LoginUser.newBuilder().mergeFrom(body)).build();
